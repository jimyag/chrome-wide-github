...
// PR files actions
"body:not(.wgh-disabled) .wgh-pr-action-bar {" +
  "display: flex;" +
  "gap: 8px;" +
  "flex-wrap: wrap;" +
  "align-items: center;" +
...
"body:not(.wgh-disabled) .wgh-pr-action-button {" +
  "padding: 5px 12px;" +
...
"body:not(.wgh-disabled) .wgh-pr-action-button:hover:not(:disabled) {" +
  "background: var(--button-default-bgColor-hover, #f3f4f6);" +
"}" +

"body:not(.wgh-disabled) .wgh-pr-action-button:disabled {" +
  "opacity: 0.6;" +
  "cursor: wait;" +
"}" +
